    ...
    return (
        <div className='2xl:px-32 lg:px-16 md:px-12 px-5 gap-4 py-4 flex flex-col border-solid border-[2px] rounded-md border-white'>
            ...
            <div className="flex justify-between">
                ...
                <p className='text-base md:text-xl ml-auto font-mono   text-[#888] text-right'>{props.address.city}, {props.address.street}</p>
            </div>
            <div className="flex justify-between">
                <p className='text-base md:text-xl font-mono text-[#888]'>{"Gender:"}</p>
                <p className='text-base md:text-xl font-mono text-[#888] text-right'>{props.gender}</p>
            </div>
            <div className="flex justify-between">
                <p className='text-base md:text-xl font-mono text-[#888]'>{"Budget:"}</p>
                <p className='text-base md:text-xl font-mono text-[#48ff23] text-right'>{props.budget}$</p>
            </div>
